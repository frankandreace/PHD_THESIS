...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{figures/kmer_methods/muset_updated.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/superkmer_definition.png}
...
\subsection{\emph{virtual} \skmer list and \kmer matrix models}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/matrix.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/querying.png}
...
\subsection{1 - Sorting \kmers from the same matrix column}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/sorting.png}
...
\subsection{2 - Construction of overlap lists between consecutive columns}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/overlap.png}
...
\subsection{3 - Maximal set of overlapping \kmers: co-linear chaining}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{figures/kmer_methods/colinear_chaining.png}
...
\subsection{4 - Reconciliation and final output}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figures/kmer_methods/reconciliation.png}
